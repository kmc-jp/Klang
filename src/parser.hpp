...
class Parser {
 public:
  ...
  ast::ComparativeExpressionPtr parse_greater_or_equal_expression();
  ast::AdditiveExpressionPtr parse_additive_expression();
  ast::AdditiveExpressionPtr parse_add_expression();
  ...
  ast::MultiplicativeExpressionPtr parse_modulo_expression();
  ...
  ast::PrimaryExpressionPtr parse_character_literal_expression();
  ast::PrimaryExpressionPtr parse_string_literal_expression();
 private:
